...
상품설명 : `;
        ...
        $confirmbtn.addEventListener('click', e => {
            ...
            if( parseInt( $('input[name="proprice"]').val() ) <= parseInt( $('input[name="prosellprice"]').val() )){
            	console.log(parseInt( $('input[name="proprice"]').val() ));
            	console.log(parseInt( $('input[name="prosellprice"]').val() ));
