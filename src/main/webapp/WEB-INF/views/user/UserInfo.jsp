                                ...
                                <table class="table">
                                    <tbody class="m-control">
                                        <tr>
                                            ...
                                            <td class="col-sm-8"><input style="width: 180px; cursor: auto;" class="form-control input-sm" name="userid"
                                                    readonly></td>
                                        </tr>
                                        <tr>
                                            <td>*이름</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input style="width: 180px;" type="password"
                                                    class="form-control input-sm" id="usePw" name="userPw"  placeholder="영문(대/소),숫자 포함 8~16자">
                                                <span id="pwChk"></span>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input style="width: 120px;" class="form-control input-sm"
                                                    id="userphone2" name="userphone2" maxlength="8" placeholder="숫자 8자리 입력">
    ...
    <script>
        ...
        $('#updateBtn').click(function() {
            ...
            //비밀번호 유효성 검사
                ...
                $('#usePw').css('background-color', 'pink');
	            $('#pwChk').html('<b style="font-size: 12px; color: red;">[영문(대/소문자), 숫자 포함 8 ~ 16자로 작성해 주세요.]</b>');
                $('#usePw').focus();
            } else { //통과
            ...
            if($('#userPwChk').val() === '') {
	            ...
	            $('#userPwChk').html('<b style="font-size: 12px; color: red;">[비밀번호 확인은 필수 정보입니다!]</b>');
                $('#userPwChk').focus();
            } else if($('#userPwChk').val() !== $('#usePw').val()) {//비밀번호 확인란 유효성 검사
                $('#userPwChk').css('background-color', 'pink');
	            $('#pwChk2').html('<b style="font-size: 12px; color: red;">[비밀번호와 일치하지 않습니다.]</b>');
            } else { //통과
