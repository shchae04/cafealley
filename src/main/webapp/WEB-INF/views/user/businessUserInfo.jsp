									...
									<tbody class="m-control">
										...
										<tr>
											...
											<td><input style="width: 180px;" type="password"
												...
												name="userPwChk"> <span id="pwChk2"></span></td>
										</tr>
										<tr>
											<td>E-mail</td>
											<td><input style="width: 180px;"
												class="form-control input-sm" name="useremail1">@ <select
												style="width: 180px;" class="form-control input-sm sel"
												name="useremail2">
					...
					.click(
							function() {
								...
								if ($('#usePw').val() === '') {
									...
									$('#pwChk')
											.html(
													'<b style="font-size: 12px; color: red;">[비밀번호는 필수 정보입니다!]</b>');
									$('#usePw').focus();
								}
								//비밀번호 유효성 검사
