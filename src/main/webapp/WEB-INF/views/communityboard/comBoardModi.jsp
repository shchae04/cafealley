				...
				<div class="row">
					<div class="col-xs-12">
						<div class="row">
							...
							<div class="col-xs-12">
								<h3 class="write-service">수정페이지</h3>
							</div>
						</div>
						<form name="writeform"
							style="border-top: 3px solid black; padding: 30px;">
							<!-- 
                      ...
                      -->
							<div class="form-group"
								style="border-bottom: 3px solid black; padding-bottom: 20px;">

								<label for="writer"> 작성자 </label> <input type="text"
									class="form-control" id="writer" name="writer" value="writer"
									readonly
									style="cursor: auto; border-color: transparent; background-color: transparent; width: 8%;">
							</div>
							<div class="form-group"
								style="border-bottom: 3px solid black; padding-bottom: 20px;">
							...
							<div class="form-group"
								style="border-top: 3px solid black; padding-top: 20px; margin-top: 20px;">
